package com.parisbeauty.cms.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.parisbeauty.cms.service.EmailAlreadyUsedException ||
            ex instanceof com.parisbeauty.cms.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.parisbeauty.cms.service.InvalidPasswordException
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "com.parisbeauty.cms");
    }
}
